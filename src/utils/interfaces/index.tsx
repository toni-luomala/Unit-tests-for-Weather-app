export type { default as Settings } from './SettingsInterface';
export type { default as FetchWeather } from './FetchWeatherInterface';
export type { default as Location } from './FavoriteInterface';
